            ...
            <div className=" px-4 md:px-6" ref={aboutInViewRef}>
                ...
                <div className="mx-auto grid gap-12 sm:py-12 py-5 md:grid-cols-2">
                    ...
                    <div className="flex flex-col items-center text-center">
                        <div className="relative h-40 w-40 overflow-hidden rounded-full sm:mb-6">
                            <Image
                                src="/SuchitProfile.jpeg" // Save the uploaded image as public/suchit-profile.png in your project
                                alt="Suchit Teli"
                                fill
                        ...
                        <p className="text-muted-foreground mb-4 sm:w-[80%] mx-auto">
